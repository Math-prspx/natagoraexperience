window.addEventListener('DOMContentLoaded', async () => {
  ...
  contentImageRemoveBtn?.addEventListener('click', () => {
    if (walkForm.elements.intro_image_url) walkForm.elements.intro_image_url.value = '';
  ...
  function setFormFromWalk(walk) {
    ...
    walkForm.elements.intro_image_url.value = walk.intro_image_url || '';
    updateCoverPreview(walk.cover_image_url || '');
    updateContentImagePreview(walk.intro_image_url || '');
  ...
  if (walkForm.elements.intro_image_url) {
    walkForm.elements.intro_image_url.addEventListener('input', (event) => {
  ...
  if (contentImageUploadInput) {
    contentImageUploadInput.addEventListener('change', async () => {
      ...
      try {
        ...
        const uploadedUrl = await uploadImageFile(file);
        walkForm.elements.intro_image_url.value = uploadedUrl;
